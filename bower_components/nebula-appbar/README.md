[![Published on webcomponents.org](https://img.shields.io/badge/webcomponents.org-published-green.svg)](https://www.webcomponents.org/element/arsnebula/nebula-appbar)
[![Polymer Version](https://img.shields.io/badge/polymer-v2-blue.svg)](https://www.polymer-project.org)
[![Sauce Labs Build Status](https://img.shields.io/badge/saucelabs-passing-red.svg)](https://saucelabs.com/beta/builds/dbfa6d947e0f44edb6eed8f98e212832)
...
An application bar layout with left, center and right slots.

* Provides left, center and right slots
* Left and right slots will fit content
* Center slot is fluid and will fill remaining space

## Installation

```
$ bower install -S arsnebula/nebula-appbar
```
...
```
<link rel="import" href="/bower_components/nebula-appbar-layout/nebula-appbar.html"> 
```
